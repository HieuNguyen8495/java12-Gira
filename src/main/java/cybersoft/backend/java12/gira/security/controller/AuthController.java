package cybersoft.backend.java12.gira.security.controller;
...
import cybersoft.backend.java12.gira.jwt.JwtUtils;
import cybersoft.backend.java12.gira.security.dto.LoginDto;
...
public class AuthController {
	...
	public Object login(@Valid @RequestBody LoginDto dto, BindingResult errors) {
		...
		try {
			...
			// log history - AOP =>xem lịch sử ai đã thao tác, tự học nâng cao
